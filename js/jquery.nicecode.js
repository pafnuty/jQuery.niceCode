/*!
	...
	Инициализация не нужна, достаточно подключить скрипт к странице.
	...
	$.fn.niceCode = function() {
		...
		make = function() {
			...
			if ($this.hasClass('wrapped')) {
				...
				.append('<div class="cn-pre-close">&times;</div>') // Добавляем кнопку закрытия.
